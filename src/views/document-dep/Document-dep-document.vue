<template xmlns:v-slot="v-slo//www.w3.org/1999/XSL/Transform">
    <div>
        <v-container class="pl-9 pr-9 pl-lg-4 pr-lg-4">
            <div>
                <div class="nf-document-info pt-5 pb-3">
                    <div>
        ...
        <v-divider></v-divider>
        <v-container>
            <ul class="nf-info-right-list pb-1">
        ...
        <v-container>
            <div class="">
                <div class="nf-document-dep-center-list mt-12">
                    <div>
                    ...
                    <div class="ml-2">
                        <div class="nf-document-dep-center-list-item-blog">
                            <p class="uzbekneftegaz-resolution">Hujjat shakli</p>
                            <p>Приказы</p>
                        </div>
                        <div class="nf-document-dep-center-list-item-blog">
                            <p class="uzbekneftegaz-resolution">Ro’yhatga olish jurnali</p>
                ...
                <div class="mt-12 nf-document-dep-comonda">
                    <div>
                        <span>
                            <svg height="20" viewBox="-79 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
